...
def main():
    ...
    for seq in sequences:
        ...
        save_scene_graph(scene_graph, seq, 'seq_graphs')
    ...
    # Save output
    today = date.today()
    special_name = f'{task_type}_T={T}_S={S}_{target_Q}_{modality_type}_{set_}_{N}samples_{today}'
